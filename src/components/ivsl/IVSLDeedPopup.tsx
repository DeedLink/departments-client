...
const IVSLDeedPopup = ({ deed, onClose }: Props) => {
  ...
  const handleSign = async () => {
    console.log("IVSL Signing deed:", deed.tokenId);
    try {
      if (!deed.tokenId) {
      ...
      console.log("ivsl_sign_response: ", sign_response);
  ...
  const handleReject = () => {
    console.log("IVSL Rejecting deed:", deed.deedNumber);
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              <div className="flex items-center justify-center gap-2">
                ...
                {isIVSLSigned ? "Already Signed" : "Sign as IVSL"}
              </div>
            </button>
            ...
            >
              <div className="flex items-center justify-center gap-2">
                ...
                {isIVSLSigned ? "Cannot Reject" : "Reject"}
              </div>
            </button>
          </div>
        </div>
