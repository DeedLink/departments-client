        ...
        {paginatedDeeds.map((deed) => (
          <div key={deed.deedNumber} className="bg-gray-50 border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
            ...
            <div className="space-y-2 text-sm mb-4">
              <p className="text-gray-700"><span className="text-gray-500 font-medium">Owner:</span> {deed.ownerFullName}</p>
              <p className="text-gray-700"><span className="text-gray-500 font-medium">Value:</span> LKR {deed.value.toLocaleString()}</p>
            </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gray-100 border-b border-gray-200">
              <th className="px-4 py-3 text-left font-medium text-gray-700">Deed Number</th>
              <th className="px-4 py-3 text-left font-medium text-gray-700">Owner</th>
              <th className="px-4 py-3 text-left font-medium text-gray-700">Land Type</th>
              <th className="px-4 py-3 text-left font-medium text-gray-700">Value (LKR)</th>
              <th className="px-4 py-3 text-center font-medium text-gray-700">Actions</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200">
            {paginatedDeeds.map((deed) => (
              <tr key={deed.deedNumber} className="hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3 text-green-600 font-mono font-medium">{deed.deedNumber}</td>
                <td className="px-4 py-3 text-gray-900">{deed.ownerFullName}</td>
                <td className="px-4 py-3 text-gray-700">{deed.landType}</td>
                <td className="px-4 py-3 text-gray-700 font-mono">{deed.value.toLocaleString()}</td>
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 bg-white border border-gray-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 shadow-sm"
            >
