...
import { User, Mail, Wallet, Shield, Calendar, FileText, CheckCircle, XCircle, Clock, TrendingUp, Award, DollarSign } from "lucide-react";
import { useLogin } from "../../contexts/LoginContext";
import { useWallet } from "../../contexts/WalletContext";
import { compressAddress, calculateIVSLAnalytics } from "../../utils/functions";
import { getDeedByIVSLWalletAddress } from "../../api/api";
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              <div className="p-6">
                <div className="text-center mb-6">
                  <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
